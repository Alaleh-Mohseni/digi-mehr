...
const Panel = () => {
	...
	return (
		<div className='shadow-[0px_8px_0px_rgba(57, 56, 56, 0.1)] absolute left-14 top-8 z-0 w-[206px] cursor-pointer rounded-md border bg-white px-[14px] pt-md transition-all'>
